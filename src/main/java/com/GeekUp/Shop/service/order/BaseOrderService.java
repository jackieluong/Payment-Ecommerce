...
import com.GeekUp.Shop.dto.request.ProductVariantDto;
import com.GeekUp.Shop.dto.response.BaseOrderResponse;
import com.GeekUp.Shop.entity.Order;
import com.GeekUp.Shop.entity.OrderItem;
...
//    private final PaymentHandlerContext paymentHandlerContext;
    ...
    public BaseOrderService(ModelMapper modelMapper, OrderRepository orderRepository, OrderItemRepository orderItemRepository, IProductService productService, IPaymentStrategy paymentService) {
